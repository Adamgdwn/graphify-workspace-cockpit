...
See `docs/2026-06-24 - deployment-guide.md` for network deployments, API key setup, and Caddy HTTPS.
...
Then walk the manual demo path in `docs/2026-06-24 - demo-path-checklist.md`.
...
| Supabase | Only if `STORAGE_BACKEND=supabase` | Check env vars and `storage.ready`; see `docs/2026-06-16 - integration-guide.md` |
| Microsoft 365 OAuth | Only if using Cloud Connectors | MSAL device code; see `docs/2026-06-16 - integration-guide.md` |
