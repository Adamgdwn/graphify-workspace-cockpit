...
- `docs/2026-06-15 - roadmap.md` — the full feature progression
- `docs/2026-06-24 - architecture.md` — component and data flow detail
- `docs/2026-06-16 - integration-guide.md` — Graphify → OS handoff contract (created in Chunk Eleven)
